    ...
    template: ` <div class="layout-topbar">
        <div class="layout-topbar-logo-container" *ngIf="appService.appDetails$ | async as appDetails">
            ...
            <a class="layout-topbar-logo" routerLink="/" >
                <img *ngIf="appDetails.appLogo" width="40px" [src]="getAppLogoSrc() + '/' + appDetails.appLogo" />
                <svg *ngIf="!appDetails.appLogo" viewBox="0 0 54 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
