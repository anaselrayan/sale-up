...
@Component({
    ...
    imports: [CommonModule, TableModule, ButtonModule, RippleModule, Tag, TranslateModule, Skeleton, RouterModule],
    template: `<div class="card !mb-8">
        <div class="font-semibold text-xl mb-4">Low Stock Products</div>
        ...
        <p-table *ngIf="!loading" [value]="products" [paginator]="true" [rows]="5" responsiveLayout="scroll">
            ...
            <ng-template #body let-product>
                <tr>
                    ...
                    <td style="width: 35%; min-width: 7rem;">{{ product.basicDetails?.productName }}</td>
