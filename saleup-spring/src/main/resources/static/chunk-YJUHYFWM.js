import{Ea as P,ab as R,wa as A,xa as g}from"./chunk-O76NRCIY.js";import{Cb as I,Cc as Q,Db as x,Ib as u,Jb as d,Kb as M,Lb as w,Mb as F,Rb as l,Sb as D,Tb as j,Tc as E,Vc as N,Wb as f,Yb as m,Z as v,Za as o,Zb as y,Zc as O,_ as h,bc as S,cc as z,da as T,dd as q,ic as B,kb as b,lb as C,ob as $,qa as p,qb as k,rb as r,zb as i}from"./chunk-VNNEODSX.js";var H=["icon"],G=["*"];function J(e,c){if(e&1&&M(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function K(e,c){if(e&1&&(w(0),r(1,J,1,1,"span",3),F()),e&2){let t=l();o(),i("ngIf",t.icon)}}function L(e,c){}function U(e,c){e&1&&r(0,L,0,0,"ng-template")}function W(e,c){if(e&1&&(u(0,"span",5),r(1,U,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var X=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
