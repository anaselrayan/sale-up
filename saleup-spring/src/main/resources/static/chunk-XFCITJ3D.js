import{Ea as P,ab as R,wa as A,xa as g}from"./chunk-F44UMLL5.js";import{$ as h,Ab as i,Db as I,Dc as Q,Eb as x,Jb as u,Kb as d,Lb as M,Mb as w,Nb as F,Sb as l,Tb as D,Ub as j,Uc as E,Wc as N,Xb as f,Zb as m,_ as v,_a as o,_b as y,_c as O,cc as S,dc as z,ea as T,ed as q,jc as B,lb as b,mb as C,pb as $,ra as p,rb as k,sb as r}from"./chunk-BMJMDHVL.js";var H=["icon"],G=["*"];function J(e,c){if(e&1&&M(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function K(e,c){if(e&1&&(w(0),r(1,J,1,1,"span",3),F()),e&2){let t=l();o(),i("ngIf",t.icon)}}function L(e,c){}function U(e,c){e&1&&r(0,L,0,0,"ng-template")}function W(e,c){if(e&1&&(u(0,"span",5),r(1,U,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var X=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
