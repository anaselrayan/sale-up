import{Ea as P,Za as R,wa as A,xa as g}from"./chunk-AQJP2JMO.js";import{Db as u,Eb as d,Fb as M,Gb as w,Hb as F,Mb as l,Nb as D,Ob as j,Oc as E,Qc as N,Rb as f,Tb as m,U as v,Ua as o,Ub as y,Uc as O,V as h,Yb as S,Zb as z,Zc as q,_ as T,dc as B,fb as b,gb as C,jb as $,la as p,lb as k,mb as r,ub as i,xb as I,xc as Q,yb as x}from"./chunk-HRECHPDI.js";var H=["icon"],G=["*"];function J(e,c){if(e&1&&M(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function K(e,c){if(e&1&&(w(0),r(1,J,1,1,"span",3),F()),e&2){let t=l();o(),i("ngIf",t.icon)}}function L(e,c){}function U(e,c){e&1&&r(0,L,0,0,"ng-template")}function W(e,c){if(e&1&&(u(0,"span",5),r(1,U,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var X=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
