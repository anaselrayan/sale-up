package com.anaselrayan.springcashiero.features.permissions.constant;

public class Permissions {

    public static final String PERM_ACCESS_DASHBOARD = "perm.access.dashboard";
    ...
    public static final String PERM_ACCESS_SALE = "perm.access.sale";
    public static final String PERM_CREATE_SALE = "perm.create.sale";
    public static final String PERM_UPDATE_SALE = "perm.update.sale";
    public static final String PERM_DELETE_SALE = "perm.delete.sale";

    public static final String PERM_ACCESS_SALE_RETURN = "perm.access.sale-return";
    public static final String PERM_CREATE_SALE_RETURN = "perm.create.sale-return";
    public static final String PERM_DELETE_SALE_RETURN = "perm.delete.sale-return";
